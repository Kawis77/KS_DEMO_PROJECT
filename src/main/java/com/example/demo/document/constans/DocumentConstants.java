...
public class DocumentConstants {
    ...
    public static final int EXTERNAL_DOC_DOCUMENT = 2;

    //TYPES OF EXTERNAL DOCUMENTS

    public static final String DOCUMENT_CONTENT_PDF =  "application/pdf";
    public static final String DOCUMENT_CONTENT_JPEG =  "image/jpeg";
    public static final String DOCUMENT_CONTENT_PNG =  "image/png";
    public static final String DOCUMENT_CONTENT_DOCX =  "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
    ...
    public static final String DOCUMENT_EXTENSION_JPEG =  ".jpeg";
    public static final String DOCUMENT_EXTENSION_PNG =  ".png";
